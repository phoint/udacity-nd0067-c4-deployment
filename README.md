...
[Udagram Endpoint](http://udagram-nd0067-653369796452.s3-website-us-east-1.amazonaws.com)


### Dependencies

```
- Node v12.14.1 (LTS) or more recent. While older versions can work it is advisable to keep node to latest LTS version
